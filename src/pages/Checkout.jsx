...
export default function Checkout() {
  ...
  // Ordering requires a logged-in account (orders are saved to the database)
  if (!user) {
    return (
      <div className="min-h-screen bg-sky-50 pt-16 flex items-center justify-center page-enter">
        <div className="text-center">
          <p className="text-gray-500 mb-4">Please log in to place your order.</p>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div>
              <div className="bg-white rounded-2xl border border-sky-100 p-5 sticky top-20">
                ...
                {submitError && (
                  <p className="text-red-500 text-xs text-center mt-3">{submitError}</p>
                )}
                <button type="submit" disabled={submitting} className="w-full btn-primary py-3 mt-4 disabled:opacity-60">
